...
void MyRobotDriver::step()
{
    ...
    auto command_motor_left = (linear_speed - angular_speed * HALF_DISTANCE_BETWEEN_WHEELS) / WHEEL_RADIUS;
    auto command_motor_right = (linear_speed + angular_speed * HALF_DISTANCE_BETWEEN_WHEELS) / WHEEL_RADIUS;
...
PLUGINLIB_EXPORT_CLASS(track_cart_driver::MyRobotDriver, webots_ros2_driver::PluginInterface)