...
IntegratedRotation::IntegratedRotation(const Eigen::Vector3f& angVel, const Bias& imuBias, float time)
{
...
void Calib::Set(const Sophus::SE3<float>& sophTbc, float ng, float na, float ngw, float naw)
{
    mbIsSet = true;
