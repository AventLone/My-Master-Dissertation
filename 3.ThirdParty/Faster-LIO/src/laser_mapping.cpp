...
{
LaserMapping::LaserMapping(const std::string& name) : rclcpp::Node(name)
{
            ...
            std::for_each(std::execution::par_unseq,
                          ...
                          [&](const size_t& i)
                          {
                              ...
                              if (ekfom_data.converge)
                              {
                                  ...
                                  {
                                      point_selected_surf_[i] = common::esti_plane(
                                          plane_coef_[i], points_near, options::ESTI_PLANE_THRESHOLD);
                                  }
                              }
